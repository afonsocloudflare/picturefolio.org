...
for (var i=0; i < sections.length; i++) {
    ...
    const list = document.createElement ('li'); //This creates a new li for menu
    list.append(newMenuItemDiv); //This adds a to the li
    console.log(list);
    navigation.append(list); //This adds menu item to nav
